...
python "C:\dev-utils\list_tree.py" "C:\projects\moreways\attribution-engine\docker" --depth 10 --ignore node_modules .expo .git __pycache__ dist build --list-scripts .ts .tsx .js .jsx .py .html .css .json .txt .sql .toml .ps1 .ejs .md .worker .api --include-readme --output "C:\projects\moreways\attribution-engine\LLM-context-docs\docker-moreways-pixel.md"
