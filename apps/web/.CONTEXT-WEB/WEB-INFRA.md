...
## Tree: C:\projects\moreways-ecosystem\apps\web\src\infra
...
### `infra/db/client.ts`
**Role:** Initializes the active database connection pool using Drizzle ORM and the Postgres driver.
**Key Exports:**
...
### `infra/db/schema.ts`
**Role:** Defines the database structure, mapping TypeScript objects to PostgreSQL tables for user and claim management.
**Key Exports:**
